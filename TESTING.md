...
# Quick validation (runs lint + type-check + sonar:check + i18n:check + build + playwright:check + tests)
pnpm validate
```
...
# Full validation (same as validate - runs lint + type-check + sonar:check + i18n:check + build + playwright:check + tests)
pnpm validate:full
