...
test.describe("Presets Functionality", () => {
  ...
  test("should display all preset cards with correct content", async ({ page }: { page: Page }) => {
    ...
    await expect(beginnerCard.locator(".preset-button")).toContainText("Apply");
  ...
  test("should apply beginner preset correctly", async ({ page }: { page: Page }) => {
    ...
    const beginnerButton = page.locator(".preset-card").first().locator(".preset-button");
  ...
  test("should apply intermediate preset correctly", async ({ page }: { page: Page }) => {
    ...
    const intermediateButton = page.locator(".preset-card").nth(1).locator(".preset-button");
  ...
  test("should apply advanced preset correctly", async ({ page }: { page: Page }) => {
    ...
    const advancedButton = page.locator(".preset-card").nth(2).locator(".preset-button");
  ...
  test("should apply multiplication preset correctly", async ({ page }: { page: Page }) => {
    ...
    const multiplicationButton = page.locator(".preset-card").nth(3).locator(".preset-button");
  ...
  test("should preserve custom settings when switching between presets", async ({
    ...
    await page.locator(".preset-card").nth(2).locator(".preset-button").click();
    await page.waitForTimeout(1000);
  ...
  test("should work correctly after language change", async ({ page }: { page: Page }) => {
    ...
    // Apply a preset
    const firstPresetButton = page.locator(".preset-card").first().locator(".preset-button");
