...
test.describe("Error Handling and Validation", () => {
  ...
  test("should display error message for invalid result range", async ({
    ...
    await page.fill("#resultRangeFrom", "50");
    await page.fill("#resultRangeTo", "10");
  ...
  test("should display error message for invalid operands range", async ({
    ...
    await page.fill("#numOperandsRangeFrom", "1");
    await page.fill("#numOperandsRangeTo", "3");

    // Trigger validation by blurring the input
    await page.locator("#numOperandsRangeFrom").blur();
